...
const PropertyDetails = ({property}) => {
  ...
  // if (property === null) {
  //   return <div className='text-center text-2xl font-bold mt-10'>loading...</div>
  // }
    ...
    <main>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 list-none">
          {property.amenities.map((element, index) => (
            <li key={index}>
              <FaCheck className='inline-block text-green-600 mr-2'/> {element}
            </li>
          ))}
        </ul>
      </div>
